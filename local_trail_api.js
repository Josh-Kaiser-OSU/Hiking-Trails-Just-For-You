...
class Trail_API {
    ...
    searchTrails(){
        return new Promise((resolve, reject) => {
            var trailData = getTrailData(this.latitude);
...
function getTrailData(latitude) {
    // Returns a trail data object from 
    if (latitude == '36.865587'){
        return {
            "trails": [
                {
                    "id": 7011192,
    ...
    } else if (latitude === '34.088808') {
        return {
            "trails": [
                {
                    "id": 7011192,
                    "name": "Beverly Hills Walk of Shame",
                    "type": "Recommended Route",
                    "summary": "The classic long mountain route in Boulder.",
                    "difficulty": "black",
                    "stars": 4.7,
